...
export function PricingModel() {
  return (
    <section className="section-padding bg-gradient-to-br from-navy via-navy to-navy-light text-paper">
      <div className="container-editorial">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          {/* Left: Content */}
          <div className="lg:pr-4">
            <p className="text-[11px] font-bold uppercase tracking-[0.3em] text-electric-blue mb-5">
              利益共担计费模型
            </p>
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-serif text-paper mb-8 leading-tight">
              我们赚钱，
              <br />
              当且仅当您赚到钱
            </h2>
            <p className="text-base lg:text-lg text-paper/65 mb-10 leading-relaxed">
                ...
                return (
                  <div key={index} className="flex gap-5">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-paper/55 leading-relaxed mb-2.5">
                        {feature.description}
                      </p>
                      <span className="inline-block px-2.5 py-1 bg-gold/20 text-gold text-[10px] font-semibold uppercase tracking-wider">
                        {feature.highlight}
                      </span>
                    </div>
                  </div>
          ...
          {/* Right: Pricing Card */}
          <div className="glass-dark p-8 lg:p-12 rounded-sm">
            <div className="text-center mb-10">
              <div className="inline-block px-4 py-1.5 border border-electric-blue/30 bg-electric-blue/10 mb-5 rounded-sm">
                <span className="text-[10px] font-bold uppercase tracking-[0.2em] text-electric-blue">
                  标准合作模式
                </span>
              </div>
              <div className="text-5xl lg:text-6xl font-serif text-paper mb-3 tracking-tight">
                5-8%
              </div>
              <div className="text-sm text-paper/50 uppercase tracking-wider">
                GMV 佣金率
              </div>
            </div>
