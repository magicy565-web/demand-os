  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      ...
      content: `Welcome to **AI Auto-Sourcing Channel** ⚡\n\n🎯 **Beta Feature: Auto Request**\n\nSimply describe your sourcing needs in natural language, and I will:\n✅ Intelligently parse your requirements\n✅ Search our product database for matches\n✅ **Automatically create a manual sourcing ticket** if no match found\n\n💡 **Try these examples**:\n• "Looking for TWS earbuds with ANC, under $10, support dropshipping"\n• "Smart watch similar to Apple Watch, around $15, MOQ 500 pcs"\n• "Power bank with wireless charging, price $8-12"\n\nStart chatting below! 👇`,
