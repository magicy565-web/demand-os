    ...
    <div className="flex h-full flex-col bg-background/80 backdrop-blur-xl border-l border-gray-200 dark:border-gray-800">
      ...
      <ScrollArea className="flex-1 [&>div>div]:!block">
        <div className="p-5 space-y-5">
          ...
          {!selectedFloor && (
            <div className="relative aspect-[16/9] rounded-xl overflow-hidden border border-gray-200/50 dark:border-gray-800/50 shadow-lg">
              <Image
                ...
                <button
                  ...
                  className={cn(
                    ...
                    selectedFloor === floor.id
                      ...
                      : "border-gray-200/50 dark:border-gray-800/50 bg-card/50 backdrop-blur-sm"
                  )}
                >
          ...
          {selectedFloorData && (
            <Card className="bg-card/50 backdrop-blur-sm border-gray-200/50 dark:border-gray-800/50 shadow-sm overflow-hidden">
                    ...
                    <button
                      ...
                      className={cn(
                        ...
                        selectedZone?.id === zone.id
                          ...
                          : "border-gray-200/50 dark:border-gray-800/50 bg-background/50"
                      )}
                    >
            ...
            <>
              ...
              {selectedZone.status === "available" && selectedZone.price > 0 && (
                <>
                  ...
                  <Card className="bg-card/50 backdrop-blur-sm border-gray-200/50 dark:border-gray-800/50 shadow-sm">
      ...
      {selectedZone && (selectedZone.status !== "available" || selectedZone.price === 0) && (
        <div className="border-t border-gray-200/50 dark:border-gray-800/50 p-5">
          <div className="rounded-xl bg-muted/50 p-4 text-center text-sm text-muted-foreground border border-gray-200/50 dark:border-gray-800/50">
            {selectedZone.status === "booked"
