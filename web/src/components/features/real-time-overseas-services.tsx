      ...
      <div className="container-editorial relative z-10">
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
          ...
          <div className="relative order-2 lg:order-1">
            <div className="aspect-video bg-white/5 border border-white/10 rounded-lg overflow-hidden group">
              <video
                autoPlay
                loop
                muted
                ...
                poster="https://demand-os-discord.oss-cn-hangzhou.aliyuncs.com/2%E6%9C%882%E6%97%A5%281%29.mp4"
              >
                <source
            ...
            {/* 装饰性光晕 */}
            <div className="absolute -inset-4 bg-gradient-to-r from-brand-blue/20 to-gold/20 blur-2xl -z-10 rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
          </div>
